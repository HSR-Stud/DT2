...
\subsection{Logische Schiebeoperatoren SLL, SRL}
	\begin{multicols}{2}
		\begin{itemize}
			...
			\item Freiwerdende Stelld wird mit Initalwert des des Basistyps aufgefüllt:
			=0.
...
\subsection{Arithmetische Schiebeoperatoren SLA, SRA}
	\begin{multicols}{2}
		\begin{itemize}
			...
			\item Bits werden um eine Stelle geschoben.
			\item Freiwerdende Stelle wird mit letztem geschobenem Bit aufgefüllt.
			\item Aus dem Indexbereich hinausgeschobener Inhalt geht verloren.
		\end{itemize}
		\begin{center}
...
\subsection{Rotierende Schiebeoperatoren SLA, SRA}
	\begin{multicols}{2}
		\begin{itemize}
			...
			\item Bits werden um eine Stelle geschoben.
			\item Freiwerdende Stelle wird mit vorderstem Bit der Kette aufgefüllt.
			\item Aus dem Indexbereich hinausgeschobener Inhalt wird hinten angehängt.
		\end{itemize}
		\begin{center}

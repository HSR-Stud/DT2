...
\begin{itemize}
  ...
  \item Zu prüfende Komponente wird unverändert aus Bibliothek übernommen.
  (Component).
  \item Testbench muss verschiedene Architekturen einfach einbinden können.
  \item Innerhalb der Architektur der Testbench dürfen auch nicht
...
\subsection{Timing Simulation}
  \subsubsection{Delta Time}
    Wird Verzögerungszeit einer Operation nicht explizit angegeben, so wird mit
  ...
  \subsubsection{Inertial}
    ...
    Y ändert Wert nur, wenn \"Anderung des Eingangs länger wirksam ist als
    delay ist. Spikes werden nicht berücksichtigt.
  \subsubsection{Transport}
    Ausgang wird in jedem Fall um delay gegenüber Eingang verschoben.

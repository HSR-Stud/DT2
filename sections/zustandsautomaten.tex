...
\subsection{Taktfrequenz}
  ...
  T>(=)t_{längster Pfad} $\\
  \textbf{Pipelining} Durch das Einfügen von zusätzlichen FF verkürzt man den längsten Pfad, dadurch wird $f_{clkMax} $ grösser, gleichzeitig wird $T_{tot}
  $ (Latency) grösser.
  \subsubsection{Bestimmung des kritischen Pfades}
    ...
    Zykluszeit = Propagation Delay der FF + Verzögerung der Transitfunktion
    (längster Pfad) + Setup der FF\\
